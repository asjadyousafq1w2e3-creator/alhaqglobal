...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      { title: "Services — AYK Solutions" },
      {
        name: "description",
        content:
          "Custom websites, web apps, automation, WordPress, Shopify, custom software and inventory management — built end-to-end by AYK Solutions.",
      },
      { property: "og:title", content: "Services — AYK Solutions" },
      {
        property: "og:description",
        content: "End-to-end software services for ambitious teams.",
      },
    ],
  }),
