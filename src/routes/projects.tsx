...
export const Route = createFileRoute("/projects")({
  head: () => ({
    meta: [
      { title: "Projects & Case Studies — AYK Solutions" },
      {
        name: "description",
        content:
          "Selected case studies from AYK Solutions — custom software, web apps, e-commerce and automation that delivered measurable outcomes.",
      },
      { property: "og:title", content: "Projects & Case Studies — AYK Solutions" },
      {
        property: "og:description",
        content: "Real outcomes from real clients — explore our case studies.",
      },
    ],
  }),
