...
export const Route = createFileRoute("/projects/$slug")({
  ...
  head: ({ loaderData }) => ({
    meta: loaderData
      ? [
          { title: `${loaderData.study.client} — Case Study | AYK Solutions` },
          { name: "description", content: loaderData.study.summary },
          { property: "og:title", content: `${loaderData.study.client} — Case Study` },
          { property: "og:description", content: loaderData.study.summary },
        ]
      : [{ title: "Case Study — AYK Solutions" }],
  }),
  notFoundComponent: () => (
    <div className="mx-auto max-w-3xl px-6 py-32 text-center">
      <h1 className="text-3xl font-display font-semibold">Case study not found</h1>
      <Link to="/projects" className="mt-6 inline-flex items-center gap-2 text-primary">
