...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact AYK Solutions — Start your project" },
      {
        name: "description",
        content:
          "Get in touch with AYK Solutions. We reply within one business day with next steps and a rough plan.",
      },
      { property: "og:title", content: "Contact AYK Solutions" },
      {
        property: "og:description",
        content: "Tell us about your project and let's build something great.",
      },
    ],
  }),
...
const faqs = [
  {
    ...
    a: "Marketing sites: 3–6 weeks. Web apps / SaaS MVPs: 10–16 weeks. Larger platforms: 12 weeks and up. We'll give you a clear estimate after the discovery call.",
  },
  {
    q: "What does it cost?",
    a: "Every project is scoped individually based on goals, features and timeline. After our free discovery call we'll share a clear estimate and proposal.",
  },
  {
  ...
  },
  {
    ...
    a: "We're remote-first with team members worldwide. We work async and overlap with your timezone when needed.",
  },
];
