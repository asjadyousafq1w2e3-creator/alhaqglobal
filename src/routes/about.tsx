...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About AYK Solutions — Premium Software Studio" },
      {
        name: "description",
        content:
          "AYK Solutions is a remote-first software studio building premium websites, apps and automations for ambitious teams worldwide.",
      },
      { property: "og:title", content: "About AYK Solutions" },
      {
        property: "og:description",
        content: "A small, senior team obsessed with craft and outcomes.",
      },
    ],
  }),
  component: AboutPage,
